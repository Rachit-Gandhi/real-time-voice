...
class Settings(BaseModel):
    ...
    transcript_db_path: str = str(ROOT_DIR / "data" / "transcripts.db")
...
def get_settings() -> Settings:
    ...
    default_db = str(ROOT_DIR / "data" / "transcripts.db")
    return Settings(
        ...
        transcript_db_path=read("TRANSCRIPT_DB_PATH", default_db) or default_db,
    )
